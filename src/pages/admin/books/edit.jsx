...
import { showBook, updateBook } from "../../../_services/book";
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              ...
              <div className="w-full">
                ...
                <input
                  ...
                  onChange={handleChange}
                  accept="image/*"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm file:bg-gray-900 file:text-white rounded-lg block w-full cursor-pointer dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-500 dark:text-white dark:focus:ring-indigo-500"
                />
              </div>
              <div className="sm:col-span-2">
                <label
